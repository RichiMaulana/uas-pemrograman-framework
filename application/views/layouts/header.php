...
<body class="bg-gray-100">
    <div class="flex h-screen overflow-hidden">
        <!-- Sidebar -->
        <div id="sidebar" class="sidebar bg-blue-800 text-white w-64 sm:block hidden h-full fixed shadow-lg">
        ...
        <!-- Main Content -->
        <div id="content" class="content flex-1 sm:ml-64 overflow-auto">
            <!-- Top Navigation -->
            <header class="bg-white shadow-sm p-4 flex justify-between items-center sticky top-0 z-10">
                <button class="sm:hidden text-gray-600" onclick="toggleSidebar()">
