  ...
  <div id="delivery-content" class="content-section">
    <div class="bg-white rounded-lg shadow overflow-hidden mb-6">
      <div class="p-6 border-b border-gray-200 flex justify-between items-center">
        <h3 class="font-semibold text-gray-800">Delivery Orders</h3>
      ...
      <div class="p-6">
        <div class="mb-4 flex justify-between items-center">
          <div class="relative w-64">
            ...
            <input type="text" placeholder="Search deliveries..." class="pl-10 pr-4 py-2 w-full rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500">
          </div>
        ...
        <div class="overflow-x-auto">
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr>
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-blue-600">DO-2023-001</td>
              ...
              <tr>
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-blue-600">DO-2023-002</td>
              ...
              <tr>
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-blue-600">DO-2023-003</td>
              ...
              <tr>
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-blue-600">DO-2023-004</td>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-blue-600">INV-2023-004</td>
        ...
        <div class="bg-gray-50 px-6 py-3 flex items-center justify-between border-t border-gray-200">
          <div class="text-sm text-gray-500">
            Showing <span class="font-medium">1</span> to <span class="font-medium">4</span> of <span class="font-medium">18</span> deliveries
          </div>
          <div class="flex space-x-2">
